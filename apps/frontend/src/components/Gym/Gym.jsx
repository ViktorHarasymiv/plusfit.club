...
function Gym() {
  ...
  const content = {
    frontImage:
      "https://res.cloudinary.com/dcmbg0k5a/image/upload/v1763907808/r106678n36ok9sok6via.jpg",
    firstParagraph: {
      ...
      contentImage: [
        ...
        "https://res.cloudinary.com/dcmbg0k5a/image/upload/v1763744593/yvoizcujmpexbkt60i3p.png",
      ],
      third:
